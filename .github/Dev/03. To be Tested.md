...
> This update takes care of Todo No. 2, which adds as callback for parsing for generation of standalone APK files, Todo 09 which fixes the missing logpath printing, and Todo No. 10, which allows functions used for standalone APK generation to not interfere when Binding with original applications.
<details>
