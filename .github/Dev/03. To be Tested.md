...
<div class="ui segment h100">
    ...
    <table class="ui very compact table" ng-show="ngrokOptionsVisible">
        <thead>
            <tr class="center aligned">
                <th colspan="4">Ngrok Tunneling Service</th>
            </tr>
        </thead>
        <tbody>
            <tr class="center aligned">
            ...
            <tr class="center aligned">
                <td colspan="4">
                    <div class="ui black segment">
                        <!-- Small black left-aligned UI log box content goes here -->
                    </div>
                </td>
            </tr>
        </tbody>
