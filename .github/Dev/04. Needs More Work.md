...
>> This function currently contains a bug that makes a mess of certain Android Manifest files when formatting them after inserting payload permissions, service and receiver, I believe that it may be to do with Manifeststhat use the `<queries />` tag.
<details>
    <Summary>Code</Summary>
