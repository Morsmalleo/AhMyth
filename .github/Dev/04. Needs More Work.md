...
<div class="ui segment h100">
    ...
    <div class="ui radio checkbox" ng-click="toggleNgrokOptions()">
    ...
    <table class="ui very compact table" ng-show="ngrokOptionsVisible" style="overflow-y: auto; max-height: 200px;">
        ...
        <tbody>
            ...
            <tr ng-show="ngrokServiceVisible">
                <td class="center aligned" style="text-align: center;" colspan="2">
                    <div class="ui labeled fluid input" style="display: inline-block;">
                        <div class="ui black label">
                            Protocol
                        </div>
                        <select class="ui dropdown center aligned" style="margin: 0 auto;">
            ...
            <tr ng-show="ngrokServiceVisible">
                <td colspan="2" class="center aligned">
                    <button class="ui icon labeled black button"><i
