## Settings Tab
> For Tunneling options, custom payload output direcotry selection and dark theme selection

<details>
    <summmary>Settings Tab</summmary>
    <br>
        ...
        <tbody>
            <tr>
                <td class="center aligned" colspan="2">
                    <div class="ui labeled fluid input">
                        ...
                        <select class="ui dropdown center aligned">
            ...
            <tr>
                <td colspan="2" class="center aligned">
                    <button class="ui icon labeled black button"><i class="arrow angle double right icon"></i>Tunnel</button>
                </td>
            </tr>
        </tbody>
    </table>
