...
<div class="ui top attached tabular menu">
    ...
    <a class="item" data-tab="smsLists" ng-click="clearLogs(); activateDefaultSmsListTab(); getInboxSMSList()">SMS Lists</a>
</div>
...
<div class="ui bottom attached tab segment h90" data-tab="smsLists">
    <div class="ui top attached tabular menu">
        <a class="item" data-tab="inboxSMSList" ng-click="clearLogs(); getInboxSMSList()">Inbox List</a>
