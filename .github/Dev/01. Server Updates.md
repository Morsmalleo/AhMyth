...
01. Updated scripts sections for the main HTML files (index.html, lab.html & notification.html) to reflect on jQuery version path update.
02. Dark theme feature (HTML side)
...
01. new dependency import `@electron/remote`
02. various dependency version updates
...
01. Adds support for any version of java 8 all the way up to java 21.
