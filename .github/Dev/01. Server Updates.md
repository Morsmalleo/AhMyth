...
<details>
    <summary>Updated "APK Browser", "GenerateApk" & "Build" functions</summary>
    <br>
...
- Constants
```js
exports.boundSignedExtension = "-aligned-debugSigned.apk"
```
                    ...
                    exec(signBoundApk, (error, stdout, stderr) => {
                        ...
                        fs.unlink(dir.join(outputPath, originApkName),
                            (err) => {
                                ...
                                delayedLog('[¡] ' + dir.join(outputPath, dir.basename(apkFolder) + CONSTANTS.boundSignedExtension), CONSTANTS.logStatus.INFO);
                                delayedLog();
