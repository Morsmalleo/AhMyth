...
<div class="ui bottom attached tab segment h90" data-tab="smsLists" style="height: 360px">
    <div class="ui top attached tabular menu">
    ...
    <div class="ui bottom attached tab {{load}} segment h90 bg" data-tab="inboxSMSList" style="overflow: scroll; height: 290px;" id="inboxParent">
    ...
    <div class="ui bottom attached tab {{load}} segment h90 bg" data-tab="sentSMSList" style="overflow: scroll; height: 290px;" id="sentParent">
        <table class="ui very compact striped table bg">
            <thead>
                <tr>
                    <th>
